...
final class CargaMasivaController
{
     ...
     */
    private function flashResultado(int $invalidas, int $omitidas, string $sustantivoChoque): void
    {
        ...
        if ($omitidas > 0) {
            $partes[] = $omitidas === 1
                ? "1 fila se omitió por un choque de {$sustantivoChoque} detectado al guardar"
                : "{$omitidas} filas se omitieron por un choque de {$sustantivoChoque} detectado al guardar";
        }
