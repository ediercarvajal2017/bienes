...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    <h1 class="h4 mb-0">Editar formato de plaqueteo</h1>
    <a href="<?= Url::to('/formatos-plaqueteo/historial') ?>" class="btn btn-sm btn-outline-secondary">Volver al histórico</a>
</div>
...
<form method="post" action="<?= Url::to('/formatos-plaqueteo/' . $registro['id'] . '/eliminar') ?>" class="mt-2"
