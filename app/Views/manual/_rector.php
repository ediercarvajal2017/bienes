    ...
    <details class="border rounded p-3 bg-white">
        ...
        <div class="mt-2 small">
            ...
            <p class="text-muted mb-0 mt-2">
                ...
                trabajo) — eso es exclusivo del superusuario.
            </p>
        </div>
    </details>
        ...
        <div class="mt-2 small">
            <ol class="mb-0 ps-3">
                <li>Entra a <strong>Categorías</strong> para crear, renombrar o desactivar las categorías con las que
                    se clasifican los bienes (Mobiliario, Tecnología, etc.).</li>
                <li>Cada bien necesita una categoría asignada antes de poder reintegrarse.</li>
            </ol>
        </div>
    </details>
