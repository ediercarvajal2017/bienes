...
echo ""
echo "Recordatorio de rendimiento: revisa en hPanel (Avanzado > Configuración de PHP)"
echo "que OPcache esté activo para este dominio. public/.user.ini ya trae el ajuste fino"
echo "(memoria, archivos acelerados), pero la extensión en sí solo se activa desde ahí."
